...
// RECIPES WITH CARD
  ...
  { name: "Porkchop marinate", type: 'f', id: "porkchopmarinate", quantity: 1, unit: "kg", ingredients: [
  ...
  { name: "Shanghai mixture", type: 'f', id: "shanghaimixture", quantity: 1.4, unit: "kg", ingredients: [
    { name: 'ground pork', ingId: "groundpork", recipe: false, quantity: 1, unit: "kg" },
    { name: 'bawang', ingId: "bawang", recipe: false, quantity: 60, unit: "g", alterQuantity: 1, alterUnit: 'bulb' },
    { name: 'sibuyas', ingId: "sibuyas", recipe: false, quantity: 60, unit: "g", alterQuantity: 1, alterUnit: 'each' },
...
// SUB-RECIPES
  ...
  { name: "Noodles palabok", type: 'g', id: "noodlespalabok", quantity: 25, unit: "cup", ingredients: [
  ...
  { name: "Noodles bihon", type: 'g', id: "noodlesbihon", quantity: 22, unit: "cup", ingredients: [
  ...
  { name: "Lumpiang Shanghai", type: 'g', id: "lumpiangshanghai", quantity: 2, unit: "each", ingredients: [
  ...
  { name: "Chicken fillet", type: 'g', id: "chickenfillet", quantity: 100, unit: "g", ingredients: [
